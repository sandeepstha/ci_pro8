	  	...
	  	<footer class="main-footer">
		    ...
		    <strong>Copyright &copy; 2014-<?php echo date('Y');?>.</strong> All rights reserved.
	  	</footer>
		...
		<!-- jQuery UI 1.11.4 -->
		<script src="<?php echo base_url(); ?>assests/bower_components/jquery-ui/jquery-ui.min.js"></script>
		...
		<script src="<?php echo base_url(); ?>assests/bower_components/morris.js/morris.min.js"></script>
		<!-- Sparkline -->
		<script src="<?php echo base_url(); ?>assests/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
		<!-- jvectormap -->
		...
		<!-- jQuery Knob Chart -->
		<script src="<?php echo base_url(); ?>assests/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
		<!-- daterangepicker -->
		<script src="<?php echo base_url(); ?>assests/bower_components/moment/min/moment.min.js"></script>
		...
		<!-- Slimscroll -->
		<script src="<?php echo base_url(); ?>assests/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
		<!-- FastClick -->
